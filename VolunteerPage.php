...
<form method="POST" action="VolunteerPage.php"> <!--refresh page when submitted-->
    ...
    Sex(please enter F/M): <input type="text" name="S"> <br /><br />
...
function handleDeleteRequest() {
    ...
    $result = executePlainSQL("SELECT ID 
                               FROM Volunteer
                               WHERE ID = '". $delete_id . "'");
    if (($row = oci_fetch_row($result)) == false) {
        echo "<br> <font color='red' face='Bradley Hand' size='5'><br />&nbsp;delete failed, no such ID</font> <br>";
    }
