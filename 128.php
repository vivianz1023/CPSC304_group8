...
<head>
    ...
    <b style="font-family:cursive; font-size:60px">Volunteer Information Page</b>
        ...
        <form method="POST" action="128.php"> <!--refresh page when submitted-->
        ...
        <form method="GET" action="128.php"> <!--refresh page when submitted-->
    ...
    <a href="https://www.students.cs.ubc.ca/~lzy0606/mainPage.php">
        ...
        function printResult($result) { //prints results from a select statement
            echo "<br>Retrieved data from table Volunteer:<br>";
            echo "<table>";
            echo "<tr>
                  <th>ID</th>
                  <th>COUNTRY</th>
